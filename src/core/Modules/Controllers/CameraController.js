...
class CameraController extends Module {
    ...
    updateSceneViewport() {
        ...
        const viewportWidth = settings.viewportWidth || 
                            (engine.canvas ? engine.canvas.width : 800);
                            
        const viewportHeight = settings.viewportHeight || 
                            (engine.canvas ? engine.canvas.height : 600);
